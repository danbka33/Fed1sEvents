...
for name, meteor in pairs(meteors) do
    ...
    data:extend({
        { -- Triggers
            type = "explosion",
            name = 'fed1s-' .. "trigger-movable-" .. name .. "-debris",
            animations = {
                {
                    direction_count = 1,
            ...
            action = {
                action_delivery = {
                    target_effects = {
                        ...
                        {
                            type = "create-entity",
                            entity_name = 'fed1s-' .. "trigger-movable-" .. name .. "-debris",
